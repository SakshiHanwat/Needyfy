  ...
  const processWithGemini = async () => {
    ...
    try {
      ...
      if (!response.ok || !result.success) {
        toast.error(result.error || "AI extraction failed. Please try again.");
        setExtracted(null);
        setStep("upload");
        return;
      }
  ...
  const saveToFirestore = async () => {
    ...
    try {
      ...
      await addDoc(collection(db, "needs"), {
        ...
        city:
          extracted.location.split(",")[1]?.trim() ||
          extracted.location.split(",")[0]?.trim() ||
          "Unknown",
        peopleAffected: extracted.peopleAffected,
        urgencyScore: Math.min(extracted.urgencyLevel * 10, 100),
            ...
            <div>
                ...
                >
                  ...
                  >
                    {[
                      ...
                      <button
                        key={mode.key}
                        onClick={() => setInputMode(mode.key as "image" | "text")}
                        style={{
                          fontFamily: "var(--font-inter)",
                          fontSize: 13,
                  ...
                  <div style={{ padding: 28 }}>
                    {inputMode === "image" ? (
                      ...
                      <div style={{ marginBottom: 20 }}>
                        ...
                        >
                          Paste or type your field report / survey notes
                        </label>
                        ...
                        >
                          💡 Hindi, English ya koi bhi regional language mein likh sakte ho
                        </p>
                      </div>
                    )}
                    ...
                    <button
                      ...
                      disabled={loading || (inputMode === "image" && !image) || (inputMode === "text" && !manualText.trim())}
                      style={{
                        width: "100%",
                        padding: "16px",
                        fontFamily: "var(--font-inter)",
                        ...
                        fontWeight: 600,
                        background:
                          loading || (inputMode === "image" && !image) || (inputMode === "text" && !manualText.trim())
                            ? "#F3F4F6"
                            : "#F97316",
                        color:
                          loading || (inputMode === "image" && !image) || (inputMode === "text" && !manualText.trim())
              ...
              {step === "processing" && (
                ...
                >
                  ...
                  >
                    Gemini AI is reading your survey...
                  </h2>
                  ...
                  >
                    Gemini Vision reading and extracting structured data...
                  </p>
                  ...
                  <div style={{ maxWidth: 320, margin: "0 auto" }}>
                    {[
                      ...
                      >
                        ...
                        <span style={{ fontFamily: "var(--font-inter)", fontSize: 13, color: "#374151" }}>
                          {s}
                        </span>
                      </div>
                    ))}
                ...
                <div>
                  ...
                  >
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      >
                        Gemini AI Extraction Successful!
                      </p>

                      <p style={{ fontFamily: "var(--font-inter)", fontSize: 12, color: "#4ADE80" }}>
                        Review the data below and save to database.
                      </p>
                    </div>
                    ...
                    {extracted.confidence && (
                      ...
                      >
                        ...
                        >
                          {confidenceBadge[extracted.confidence]?.label || "⚠️ Medium Confidence"}
                        </span>
                      </div>
                    )}
                  </div>
                    ...
                    <div style={{ padding: 28 }}>
                      ...
                      >
                        {[
                          ...
                          { label: "⚡ Urgency Score", value: `${Math.min(extracted.urgencyLevel * 10, 100)}/100` },
                      ...
                      <div style={{ marginBottom: 28 }}>
                        <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 8 }}>
                          ...
                          <span
                            style={{
                              ...
                              fontWeight: 600,
                              color:
                                extracted.urgencyLevel >= 8
                                  ? "#EF4444"
                                  : extracted.urgencyLevel >= 6
                                  ? "#F59E0B"
                                  : "#10B981",
                            }}
                          >
                            {extracted.urgencyLevel >= 8 ? "🔴 High" : extracted.urgencyLevel >= 6 ? "🟡 Medium" : "🟢 Low"}
                          </span>
                        </div>
                        ...
                        <div style={{ height: 8, background: "#F1F5F9", borderRadius: 999 }}>
                          <div
                            style={{
                              height: "100%",
                              width: `${Math.min(extracted.urgencyLevel * 10, 100)}%`,
                              borderRadius: 999,
                              background:
                                extracted.urgencyLevel >= 8
                                  ? "#EF4444"
              ...
              {step === "saved" && (
                ...
                >
                  ...
                  >
                    Community need added to database.
                    <br />
                  ...
                  >
                    ...
                    >
                      🤖 AI matching volunteers...
                    </p>

                    <p style={{ fontFamily: "var(--font-inter)", fontSize: 12, color: "#9CA3AF" }}>
                      Top 3 matching volunteers will be notified shortly.
                    </p>
                  </div>
              ...
              >
                ...
                {[
                  ...
                  <div key={item.step} style={{ display: "flex", gap: 14, marginBottom: 16, alignItems: "flex-start" }}>
                    ...
                    >
                      <span style={{ color: "white", fontSize: 12, fontWeight: 700 }}>{item.step}</span>
                    </div>
                    ...
                    <div>
                      ...
                      <p style={{ fontFamily: "var(--font-inter)", fontSize: 12, color: "#6B7280" }}>{item.desc}</p>
                    </div>
                  </div>
                ))}
              </div>
              ...
              >
                ...
                {[
                  ...
                  <div key={tip} style={{ display: "flex", gap: 8, marginBottom: 8, alignItems: "flex-start" }}>
                    ...
                    <span style={{ fontFamily: "var(--font-inter)", fontSize: 12, color: "#6B7280" }}>{tip}</span>
                  </div>
                ))}
              </div>
            </div>
